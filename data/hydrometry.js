...
class dataFish{
    ...
    async getPlaces(page){
        var places = [];
        var url = "https://hubeau.eaufrance.fr/api/v1/hydrometrie/referentiel/stations?format=json&size=2000";
        console.log(url)
        ...
        for(var place of places){
            place.x = place.longitude_station;
            place.y = place.latitude_station;
        }
        return places;
    }
